...
if("Windows" %in% Sys.info()['sysname'] == TRUE){ 
        ...
        write_csv(lod_apple, "H:/GitHub Projects/C6-Pesticide-Validation/GC outputs/LOD_LOR_Apple.csv")
} else { 
        write_csv(lod_apple, "/Users/Study Old/Documents/GitHub/C6 Pesticide Validation/GC outputs/LOD_LOR_Apple.csv")
...
if("Windows" %in% Sys.info()['sysname'] == TRUE){ 
        ...
        write_csv(lod_spinach, "H:/GitHub Projects/C6-Pesticide-Validation/GC outputs/LOD_LOR_Spinach.csv")
} else { 
        write_csv(lod_spinach, "/Users/Study Old/Documents/GitHub/C6 Pesticide Validation/GC outputs/LOD_LOR_Spinach.csv")
