...
if("Windows" %in% Sys.info()['sysname'] == TRUE){ 
        ...
        write_csv(GC_wide, "H:/GitHub Projects/C6-Pesticide-Validation/GC outputs/Recovery_Matrix.csv")
} else { 
        write_csv(GC_wide, "/Users/Study Old/Documents/GitHub/C6 Pesticide Validation/GC outputs/Recovery_Matrix.csv")
